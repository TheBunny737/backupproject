 ...
 *
 * @help
 *   Galv's Disable CommandRemember
 * ----------------------------------------------------------------------------
...
Galv.DASH.disable = PluginManager.parameters('GALV_DisableCommandremember')["Disable Option"].toLowerCase() == 'true' ? true : false;


if (Galv.Commandremember.disable) {
	Galv.Commandremember.Window_Command_addCommand = Window_Command.prototype.addCommand;
	Window_Options.prototype.addCommand = function(name, symbol, enabled, ext) {
		if (symbol === 'commandRemember') return;
